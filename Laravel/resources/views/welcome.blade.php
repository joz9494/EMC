...
<style>
    ...
    #contenedorbtn{
        background-image: url("Laravel/Recursos/img/Inicio/btn.png");
        background-size: 100%;
        width: 500px;
        height: 90px;
        margin-top: -2%;
    ...
    #contenedorbtn:hover{
        background-image: url("Laravel/Recursos/img/Inicio/btn2.png");
        background-size: 100%;
        width: 500px;
        height: 90px;
        margin-top: -2%;
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" id="imgcarrousel" src="Laravel/Recursos/img/Inicio/11.png" alt="First slide">
                </div>
