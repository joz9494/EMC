                    ...
                    <div id="barramenu">
                        <div class="menu-desktop" id="navmenu">
                            <ul class="main-menu" id="navmenu" style="width: 100%">
                                <a href="<?php echo e(url('/')); ?>"><img src="../Recursos/img/logo.png" id="imglogo" width="100px" height="100px"></a              >
                                <li id="activarmenu" style="margin-left: 5%;">
                                    <div id="linea"></div>
                                    <a href="<?php echo e(url('/')); ?>" id="letrasmenu">Inicio</a>
                                </li>
                
                                <li id="activarmenu">
                                    <div id="linea"></div>
                                    <a href="<?php echo e(url('/Servicios')); ?>" id="letrasmenu">Servicios</a>
                                </li>

                                <li id="activarmenu">
                                    <div id="linea"></div>
                                    <a href="<?php echo e(url('/Acerca_de_EMC')); ?>" id="letrasmenuA">Acerca de E.M.C</a>
                                    <a href="<?php echo e(url('/Acerca_de_EMC')); ?>" id="letrasmenuA2">E.M.C</a>
                                </li>
                
                                <li id="activarmenu">
                                    <div id="linea"></div>
                                    <a href="<?php echo e(url('/Tratamientos')); ?>" id="letrasmenu">Tratamientos</a>
                                </li>
                
                                <li id="activarmenu">
                                    <div id="linea"></div>
                                    <a href="<?php echo e(url('/Hormonas')); ?>" id="letrasmenu">Contacto</a>
                                </li>
